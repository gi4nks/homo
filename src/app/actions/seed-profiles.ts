...
/**
 * SEED AI PROFILES
 * Mass-populates the database with specialized writing personas.
 * Uses upsert to prevent duplicates based on the 'name' field.
 */
export async function seedAiProfiles() {
  ...
  try {
    console.log("--- STARTING AI PROFILE SEEDING ---");
